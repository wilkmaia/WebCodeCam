...
function(a){l||f.paused||(a.data.success&&1<a.data.result[0].length&&-1==a.data.result[0].indexOf("undefined")?(l=!0,d.data().plugin_WebCodeCam.delay(),d.data().plugin_WebCodeCam.beep(),d.data().plugin_WebCodeCam.options.resultFunction(a.data.result[0],n)):a.data.finished&&(r=!r,setTimeout(function(){d.data().plugin_WebCodeCam.tryParseBarecode()},200)))};qrcode.callback=function(a){l||f.paused||(l=!0,d.data().plugin_WebCodeCam.delay(),d.data().plugin_WebCodeCam.beep(),d.data().plugin_WebCodeCam.options.resultFunction(a,
...
d.data().plugin_WebCodeCam.tryParseBarecode();d.data().plugin_WebCodeCam.options.ReadQRCode&&d.data().plugin_WebCodeCam.tryParseQRCode()},2E3)},getLastImageSrc:function(){return n},optimalZoom:function(a){return f.videoHeight/h},getImageLightness:function(){pixels=k.getImageData(0,0,g,h);for(var a=pixels.data,e=0,b,c,d,f=0,x=a.length;f<x;f+=4)b=a[f],c=a[f+1],d=a[f+2],b=Math.floor((b+c+d)/3),e+=b;return Math.floor(e/(g*h))},brightness:function(a,e){e=0==e&&0!=this.options.autoBrightnessValue?this.options.autoBrightnessValue-
